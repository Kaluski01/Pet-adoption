...
export default function About() {
  ...
  <div className="container"bg="dark" variant="dark">
      <div className="row w-100">
        <div className="col-lg-12 col-12 w-100 text-center">
          <div className='first-texts'>
            <h1 className='firsts-h1 font-weight-bold'>Welcome to PET FINDER</h1>
      ...
      <div className="row">
        <div className="col-lg-12 col-12" style={{ color: 'black', marginTop:'30px' }}>
